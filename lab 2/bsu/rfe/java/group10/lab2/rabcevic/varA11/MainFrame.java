package bsu.rfe.java.group10.lab2.rabcevic.varA11;
...
public class MainFrame extends JFrame {
	...
	public Double calculate1(Double x, Double y, Double z) {
		double a = Math.pow((Math.log(z)+Math.sin(PI*Math.pow(z,2))), 1/4);
		double b = Math.pow((Math.pow(y, 2)+Math.exp(Math.cos(x))+Math.sin(y)),Math.sin(x));
		return a/b;
	}
	public Double calculate2(Double x, Double y, Double z) {
		double a = 1+Math.sqrt(z*x);
		double b = Math.pow((1+Math.pow(x,3)), 1/y);
		return a/b;
	}
	...
	public MainFrame() {
        ...
        String path1 = "C:\\Users\\Honor\\eclipse-workspace\\Lab2\\src\\bsu\\rfe\\java\\group10\\lab2\\rabcevic\\varA11\\f1.bmp";
        ImagePanel im1 = new ImagePanel(path1);
        imBox1.add(im1);
        String path2 = "C:\\Users\\Honor\\eclipse-workspace\\Lab2\\src\\bsu\\rfe\\java\\group10\\lab2\\rabcevic\\varA11\\f2.bmp";
