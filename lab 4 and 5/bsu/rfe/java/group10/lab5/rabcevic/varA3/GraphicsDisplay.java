package bsu.rfe.java.group10.lab5.rabcevic.varA3;
...
public class GraphicsDisplay extends JPanel {
    ...
    protected void paintAxis(Graphics2D canvas) {
        ...
        if (this.viewport[1][1] <= 0.0 && this.viewport[0][1] >= 0.0) {
            ...
            // Установка позиции для рисования "0" на пересечении осей
            Point2D centerPoint = this.xyToPoint(0.0, 0.0);
            bounds = this.axisFont.getStringBounds("0", context);
            canvas.drawString("0", (float)(centerPoint.getX() - bounds.getWidth() / 2.0), (float)(centerPoint.getY() - bounds.getHeight() / 2.0));
        }
    }
