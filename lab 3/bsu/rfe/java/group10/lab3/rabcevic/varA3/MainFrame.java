package bsu.rfe.java.group10.lab3.rabcevic.varA3;
...
public class MainFrame extends JFrame {
	...
	public MainFrame(Double[] coefficients) {
		...
		AbstractAction aboutProgrammAction = new AbstractAction("О программе") {
		    public void actionPerformed(ActionEvent event) {
		        String photoPath = "C:\\Users\\Honor\\eclipse-workspace\\Lab3\\src\\photo.jpg"; // Путь к фотографии
		        
		        String surname = "Рабцевич Карина";
		        String group = "10";
		        
		        JPanel panel = new JPanel();
		        panel.add(new JLabel("Фамилия: " + surname));
		        panel.add(new JLabel("Группа: " + group));
		        panel.add(new JLabel(new ImageIcon(photoPath)));
